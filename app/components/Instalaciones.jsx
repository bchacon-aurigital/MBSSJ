...
const SobreNosotros = () => {
  ...
  return (
    <section className="bg-black text-white w-full py-10 px-4 md:px-16">
      <div className="mb-4 text-lg font-sofia font-medium text-[#8D8D8D] uppercase">{t('instalaciones.sectionTitle')}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 lg:min-h-[550px]">
          <div className="lg:border-r border-b border-t border-[#7D7D7D]/20 p-3 md:p-6">
           <div className="p-4 text-3xl rounded-md bg-[#F80000] text-black w-16 flex justify-center items-center"><IoShieldCheckmark /></div>
            <h2 className="text-xl md:text-4xl font-impact font-bold text-[#F80000] mb-3 uppercase mt-6 md:mt-12" dangerouslySetInnerHTML={{ __html: t('instalaciones.cards.comodidad.title') }}></h2>
          ...
          <div className="p-4 text-3xl rounded-md bg-[#F80000] text-black w-16 flex justify-center items-center"><FaBookBookmark /></div>
            <h2 className="text-xl md:text-4xl font-impact font-bold text-[#F80000] mb-3 uppercase mt-6 md:mt-12" dangerouslySetInnerHTML={{ __html: t('instalaciones.cards.tatami.title') }}></h2>
          ...
          <div className="p-4 text-3xl rounded-md bg-[#F80000] text-black w-16 flex justify-center items-center"><FaClock /></div>
            <h2 className="text-xl md:text-4xl font-impact font-bold text-[#F80000] mb-3 uppercase mt-6 md:mt-12" dangerouslySetInnerHTML={{ __html: t('instalaciones.cards.areaEspera.title') }}></h2>
          ...
          <div className="p-4 text-3xl rounded-md bg-[#F80000] text-black w-16 flex justify-center items-center"><MdShower /></div>
            <h2 className="text-xl md:text-4xl font-impact font-bold text-[#F80000] mb-3 uppercase mt-6 md:mt-12" dangerouslySetInnerHTML={{ __html: t('instalaciones.cards.duchas.title') }}></h2>
