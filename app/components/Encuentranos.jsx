      ...
      <div className="grid grid-cols-1 xl:grid-cols-2">
        <div className="md:col-span-1 flex flex-col justify-center border-[#7D7D7D]/50 border-t border-l-0 border-b border-r-0 py-14 order-last xl:pl-6">
          ...
          <div className="z-50" data-aos="fade-up" data-aos-delay="100">
            <a href="https://www.google.com/maps/dir/?api=1&destination=9.957320531608%2C-84.196410943883" className="bg-[#F80000] uppercase hover:bg-white hover:text-black duration-500 text-black font-medium font-impact py-3 px-12 rounded transition-all w-fit text-md">
