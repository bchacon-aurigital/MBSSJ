    ...
    <section className="bg-black text-white w-full py-10 px-4 md:px-16">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2">
        <div className="md:col-span-1 flex flex-col justify-center border-[#F80000]/50 border-t border-l-0 border-b border-r-0 py-14 order-last xl:pl-6">
          <h1 className="text-3xl md:text-6xl font-impact font-bold text-white mb-4" dangerouslySetInnerHTML={{ __html: t('encuentranos.title') }}>
          </h1>
          ...
          <div className="z-50" data-aos="fade-up" data-aos-delay="100">
            <a href="https://www.google.com/maps/dir/?api=1&destination=9.957320531608%2C-84.196410943883" className="bg-[#F80000] uppercase hover:bg-white text-black duration-500 font-medium font-impact py-3 px-12 rounded transition-all w-fit text-md">
